...
if ($result) {
    echo "
        <script>
            ...
            window.location.href = 'nicogen.php';
        </script>
    ";
} else {
    echo '<script>alert("Error: ' . $sql . '\n' . $conn->error . '"); window.history.go(-1); document.getElementById("nicogen").reset();</script>';
}
