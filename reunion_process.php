...
if (isset($_POST['submit'])) {
    ...
    $Basic_Premium = $_POST['Basic_Premium'];
     ...
     $sql = "INSERT INTO reunion (Officer_Responsible, Policy_No, Start_Date, Renewal_Date,Policy_Holder,Contact_Details,  Regn_No, Purpose_Type, Vehicle_Make, Type_of_Cover,Value_of_Vehicle,Basic_Premium) VALUES ('$Officer_Responsible', '$Policy_No', '$Start_Date', '$Renewal_Date','$Policy_Holder','$Contact_Details',   '$Regn_No', '$Purpose_Type', '$Vehicle_Make', '$Type_of_Cover','$Value_of_Vehicle','$Basic_Premium')";
